...
# start calulcation
gray_image = cv2.imread(r'C:\Users\KAT MONTERO\Downloads\crack.jpg', 0)
...
temp_filename = 'wallcrack.jpg'
temp_file_directory = 'C:/Users/KAT MONTERO/Desktop/NOAH FILES/TESTS/PY-APP/DETECT-CRACK-IN-IMAGE/storage'
...
if with_nmsup is False:
    ...
    cv2.imshow('wallcrack-detected', result)
    cv2.waitKey()
